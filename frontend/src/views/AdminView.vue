...
import type { BggCacheStats, AdminStats, ServiceHealth, AdminUser, AdminGroup } from '@/services/adminApi'

const auth = useAuthStore()

const activeTab = ref<'dashboard' | 'users' | 'groups' | 'locations' | 'bggCache'>('dashboard')
        ...
        <div v-else class="space-y-3">
          ...
          >
            ...
            <div class="flex-shrink-0">
              ...
              >
                <svg v-if="suspendingUserId === user.id" class="animate-spin -ml-1 mr-2 h-4 w-4" fill="none" viewBox="0 0 24 24">
                  <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                  <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"></path>
                </svg>
                Unsuspend
