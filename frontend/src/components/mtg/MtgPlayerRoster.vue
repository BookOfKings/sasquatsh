    ...
    <div class="p-4">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
        ...
        <div
          ...
          :class="reg.userId === hostUserId ? 'bg-purple-50 border border-purple-200' : 'bg-gray-50'"
        >
          <div class="relative">
            <UserAvatar
            ...
            <div
              ...
              class="absolute -bottom-1 -right-1 w-6 h-6 bg-purple-600 rounded-full flex items-center justify-center"
              title="Host"
            >
