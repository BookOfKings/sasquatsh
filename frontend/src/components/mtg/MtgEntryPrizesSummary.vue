...
const hasInfo = computed(() => {
  return (props.config.entryFee !== null && props.config.entryFee > 0) || props.config.hasPrizes
})
</script>
  ...
  <div v-if="hasInfo" class="card">
    ...
    <div class="p-4">
      <div class="flex flex-wrap gap-6">
        <!-- Entry Fee -->
        <div v-if="config.entryFee !== null && config.entryFee > 0" class="flex items-center gap-3">
